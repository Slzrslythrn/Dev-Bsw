    ...
    <div class="row page-titles mx-0">
        ...
        <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active"><a href="javascript:void(0)">Menu Pengumuman</a></li>
            </ol>
        </div>
    </div>
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <a href="{{ route('pengumuman.add') }}" class="btn btn-primary">Tambah Pengumuman</a>
                </div>
                <div class="card-body">
                            ...
                            <tbody>
                                ...
                                @foreach ($pengumuman as $row)
                                    <tr>
                                        <td>{{ $no++ }}</td>
                                        <td>
                                            <img src="{{ asset('uploads/banner/' . $row->banner) }}" alt=""
                                        ...
                                        <td>
                                            <div class="d-flex">
                                                <a href="{{ route('pengumuman.edit', ['id' => $row->id]) }}"
                                                    class="btn btn-primary mx-2">Edit</a>
                                                {{-- hapus --}}
                                                <form id="hapus-form{{ $row->id }}"
                                                    action="{{ route('pengumuman.destroy', ['id' => $row->id]) }}"
